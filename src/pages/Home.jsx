...
export function Home() {
    ...
    function handleIntro(event) {
        setIntromod(event.target.value)
    }

    const introContentDisplay = () => {
        if (introMod === "overview") {
            return(
                <p>I'm a guitarist of 8 years, I started with acoustic guitar where I learnt the basics of guitars e.g basic riffs and chords. 
                As time went on I was moving into my teenage years and started getting an interest in indie rock music with bands such as the Arctic Monkeys. 
                Throughout my journey I started with lessons for the first 6 years and got to a mid grade 3 to early grade 4 level on electric guitar</p>
            )}
        else if (introMod === "challenge") {
            return (
            ...
            return (
                ...
                my motivation streak but the main point is how much progress I made in such little time with the help of structure.</p>
        )}
        else {
            return (
                ...
                rabbit hole I have so this is not only something I'm using in attempt of impressing recuiters it's also something I hope helps other guitarists to find 
        ...
        <>
            ...
            <div style = {CardStyle}>
                <select style = {input} value = {introMod} onChange={handleIntro}>
                    <option value = "overview">Overview of my guitar journey</option>
                    <option value = "motivation">What Motivates my Playing</option>
